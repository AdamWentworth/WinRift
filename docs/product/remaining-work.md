...
Status: items 1-10 have been addressed in the current cleanup pass. The next product pass should be deeper live-page modularization or the next backend read model, not basic page scaffolding.
