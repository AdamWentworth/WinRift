...
CREATE TABLE IF NOT EXISTS winrift.summoner_account_snapshots
(
    puuid String,
    platform LowCardinality(String),
    summoner_id String,
...
CREATE TABLE IF NOT EXISTS winrift.summoner_champion_role_summary
(
    platform LowCardinality(String),
    queue_id UInt16,
    puuid String,
...
CREATE TABLE IF NOT EXISTS winrift.summoner_recent_match_summary
(
    platform LowCardinality(String),
    queue_id UInt16,
    puuid String,
...
CREATE TABLE IF NOT EXISTS winrift.summoner_build_summary
(
    platform LowCardinality(String),
    queue_id UInt16,
    puuid String,
...
CREATE TABLE IF NOT EXISTS winrift.build_signature_analytics
(
    patch LowCardinality(String),
    platform LowCardinality(String),
    queue_id UInt16,
...
CREATE TABLE IF NOT EXISTS winrift.champion_role_analytics
(
    patch LowCardinality(String),
    platform LowCardinality(String),
    queue_id UInt16,
...
CREATE TABLE IF NOT EXISTS winrift.champion_guide_scope_analytics
(
    patch LowCardinality(String),
    platform LowCardinality(String),
    queue_id UInt16,
...
CREATE TABLE IF NOT EXISTS winrift.champion_matchup_analytics
(
    patch LowCardinality(String),
    platform LowCardinality(String),
    queue_id UInt16,
...
CREATE TABLE IF NOT EXISTS winrift.champion_signature_analytics
(
    patch LowCardinality(String),
    platform LowCardinality(String),
    queue_id UInt16,
...
CREATE TABLE IF NOT EXISTS winrift.participant_performance
(
    match_id String,
    platform LowCardinality(String),
    patch LowCardinality(String),
