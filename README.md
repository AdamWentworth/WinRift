...
The repository code is MIT licensed. Riot-owned names, icons, splash art, and screenshots containing Riot imagery are not covered by the MIT license; see [NOTICE.md](NOTICE.md).
