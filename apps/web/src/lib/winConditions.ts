...
export const WIN_CONDITION_DEFINITIONS: WinConditionDefinition[] = [
  ...
  },
  {
    ...
    accent: '#72e0ca',
    plainEnglish: 'Win by making important areas miserable for the enemy to enter. Control teams are about terrain, zones, traps, peel, objective setup, and denying clean access.',
    mapPattern: 'Arrive first, establish vision, hold choke points, and make the enemy spend health or cooldowns just to walk into river or jungle entrances.',
    teamNeeds: 'Zone denial, peel, terrain tools, traps, slows, durable front line, and disciplined objective setup.',
    commonFailure: 'Showing up late, chasing out of controlled space, or treating control as passive scaling instead of proactive setup.',
    examples: ['Braum', 'Janna', 'Poppy', 'Ivern', 'Nunu & Willump'],
  },
  {
    key: 'TeamFight',
    label: 'Team Fight',
